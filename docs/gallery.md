...
<figcaption>Gray–Scott mitosis regime (<code>gray_scott_2d</code>)</figcaption>
</figure>
<figure class="pf-motion-item" markdown>
<video autoplay loop muted playsinline>
<source src="../figures/kolmogorov_motion.mp4" type="video/mp4">
</video>
<figcaption>Forced 2D turbulence (<code>kolmogorov_flow_2d</code>, JAX backend)</figcaption>
</figure>
<figure class="pf-motion-item" markdown>
<video autoplay loop muted playsinline>
<source src="../figures/shallow_water_motion.mp4" type="video/mp4">
</video>
<figcaption>Shallow-water waves (<code>shallow_water_2d</code>)</figcaption>
</figure>
<figure class="pf-motion-item pf-wide" markdown>
<video autoplay loop muted playsinline>
<source src="../figures/cylinder_turbulent_motion.mp4" type="video/mp4">
</video>
<figcaption>Re 2000 wake vorticity, base shear removed (<code>cylinder_flow_2d_turbulent</code>, LES)</figcaption>
</figure>
</div>
...
<figcaption>Gray–Scott mitosis (<code>gray_scott_2d</code>)</figcaption>
</figure>
<figure markdown>
...
<figcaption>Waves in a random medium (<code>heterogeneous_wave_2d</code>)</figcaption>
</figure>
<figure markdown>
![Darcy 3D](figures/darcy3d_hero.png)
<figcaption>Darcy pressure in 3D (<code>darcy_fno_3d</code>)</figcaption>
</figure>
<figure markdown>
![3D spinodal decomposition](figures/spinodal3d.png)
<figcaption>Spinodal interface in 3D (<code>cahn_hilliard</code>)</figcaption>
</figure>
</div>
